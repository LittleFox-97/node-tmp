  ...
  describe('#dirSync()', () => {
    ...
    describe('when running standard outband tests', () => {
      it('on graceful cleanup', function (done) {
        childProcess(this, 'graceful-dir-sync.json', (err, stderr, stdout) => {
          if (err) {
            return done(err)
          }
          if (!stderr) {
      ...
      it('on non graceful cleanup', function (done) {
        childProcess(this, 'non-graceful-dir-sync.json', (err, stderr, stdout) => {
          if (err) {
            return done(err)
          }
          if (!stderr) {
      ...
      it('on keep', function (done) {
        childProcess(this, 'keep-dir-sync.json', (err, stderr, stdout) => {
          if (err) {
            return done(err)
          }
          if (stderr) {
      ...
      it('on unlink (keep == false)', function (done) {
        childProcess(this, 'unlink-dir-sync.json', (err, stderr, stdout) => {
          if (err) {
            return done(err)
          }
          if (stderr) {
      ...
      it('on unsafe cleanup', function (done) {
        childProcess(this, 'unsafe-sync.json', (err, stderr, stdout) => {
          if (err) {
            return done(err)
          }
          if (stderr) {
      ...
      it('on non unsafe cleanup', function (done) {
        childProcess(this, 'non-unsafe-sync.json', (err, stderr, stdout) => {
          if (err) {
            return done(err)
          }
          if (stderr) {
    ...
    describe('when running issue specific outband tests', () => {
      it('on issue #62', function (done) {
        childProcess(this, 'issue62-sync.json', (err, stderr, stdout) => {
          if (err) {
            return done(err)
          }
          if (stderr) {
